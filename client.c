...
void chooseOption(int sd){
	...
	write(1,"Choose option : ",sizeof("Choose option : "));
	scanf("%d",&option);
	printf("Option : %d\n",option);
	//option=option-2608;
...
void addAccount(int sd){
	...
	if(type==1){
		normalUser addUser1;
		write(1,"Name of the account holder(max 20 characters) : ",sizeof("Name of the account holder(max 20 characters) : "));
		scanf(" %[^\n]",addUser1.name);
	...
	if(type==2){
		jointUser addUser2;
		write(1,"Name of the primary account holder(max 20 characters) : ",sizeof("Name of the primary account holder(max 20 characters) : "));
		scanf(" %[^\n]",addUser2.name1);
		write(1,"Name of the other holder(max 20 characters) : ",sizeof("Name of the other holder(max 20 characters) : "));
		scanf(" %[^\n]",addUser2.name2);
		write(1,"Password(max 10 characters) : ",sizeof("Password(max 10 characters) : "));
...
void modifyAccount(int sd){
	...
	if(type==1){
		...
		write(1,"New Name of the account holder(max 20 characters) : ",sizeof("New Name of the account holder(max 20 characters) : "));
		scanf(" %[^\n]",modUser1.name);
	...
	if(type==2){
		...
		write(1,"New Name of the primary account holder(max 20 characters) : ",sizeof("New Name of the primary account holder(max 20 characters) : "));
		scanf(" %[^\n]",modUser2.name1);
		write(1,"New Name of the other holder(max 20 characters) : ",sizeof("New Name of the account holder(max 20 characters) : "));
		scanf(" %[^\n]",modUser2.name2);
		write(1,"New Password(max 10 characters) : ",sizeof("New Password(max 10 characters) : "));
